...
export default function AddAccountModalForm({ onClose, onAccountAdded }: AddAccountFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    if (!result.success) {
      // handle backend-level validation errors if needed
      return;
    }
     ...
     <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4">
            ...
            <input type="number" {...register("startingBalance")} className="w-full p-2 border rounded" />
